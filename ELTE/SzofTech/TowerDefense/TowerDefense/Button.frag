...
// fénytulajdonságok
uniform vec3 light_pos = vec3(15,15,15);

uniform vec4 La = vec4(1, 1, 1, 1);
...
void main()
{
	...
	fs_out_col = vec4(((ambient + diffuse + specular) * texture(texImage, vs_out_tex0.st)).xyz, meshID / 256.0);
