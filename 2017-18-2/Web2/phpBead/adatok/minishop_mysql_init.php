...
// használata
$kapcsolat = kapcsolodas('mysql:host=localhost;dbname=wf2_fgsdv2;charset=utf8', 'shsvos', 'shsvos');
...
vegrehajtas($kapcsolat, "DROP TABLE IF EXISTS felhasznalok;");
...
print_r($result);
$result = lekerdezes($kapcsolat, "SELECT * FROM felhasznalok");
print_r($result);
echo '/<pre>';
